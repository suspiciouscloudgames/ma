...
assert.ok(scripts.includes('translate-workshop')&&scripts.includes('workshop-translation')&&scripts.includes('translation_en')&&scripts.includes('translation_ko'),'Automatic translation UI is not published yet');
