...
export default function RespondPage(){
 ...
 if(state.display_mode!=='play')return <main className="connect-page"><section className="connect-card connect-finished"><Link href="/">{en?'Back':'돌아가기'}</Link></section></main>;
